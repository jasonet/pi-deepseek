...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.providers.customDesc": "Connect OpenAI-compatible servers and expose their models in Pi-Deepseek.",
    ...
    "update.downloadingDesc": "Pi-Deepseek can stay open during the download.",
    "update.downloadProgress": "Update download progress",
    "update.ready": "Version {version} is ready",
    "update.readyDesc": "Restart Pi-Deepseek to apply the update. Your sessions are preserved.",
  ...
  "zh-CN": {
    ...
    "settings.providers.customDesc": "连接 OpenAI 兼容服务，并在 Pi-Deepseek 中使用其模型。",
    ...
    "update.downloadingDesc": "下载期间 Pi-Deepseek 可继续保持运行。",
    "update.downloadProgress": "更新下载进度",
    "update.ready": "版本 {version} 已准备好",
    "update.readyDesc": "重启 Pi-Deepseek 即可应用更新，会话内容将保留。",
    "update.failed": "更新失败",
  ...
  "zh-TW": {
    ...
    "settings.providers.customDesc": "連線 OpenAI 相容服務，並在 Pi-Deepseek 中使用其模型。",
    ...
    "update.downloadingDesc": "下載期間 Pi-Deepseek 可繼續保持執行。",
    "update.downloadProgress": "更新下載進度",
    "update.ready": "版本 {version} 已準備好",
    "update.readyDesc": "重新啟動 Pi-Deepseek 即可套用更新，工作階段內容將保留。",
    "update.failed": "更新失敗",
  ...
  ja: {
    ...
    "settings.providers.customDesc": "OpenAI 互換サーバーを接続し、Pi-Deepseek でモデルを使用します。",
    ...
    "update.downloadingDesc": "ダウンロード中も Pi-Deepseek を使用できます。",
    "update.downloadProgress": "更新のダウンロード進行状況",
    "update.ready": "バージョン {version} の準備ができました",
    "update.readyDesc": "Pi-Deepseek を再起動して更新を適用します。セッションは保持されます。",
