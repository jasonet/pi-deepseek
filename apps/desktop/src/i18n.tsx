...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.providers.customAdd": "OpenAI-compatible provider",
    "settings.providers.customAddDesc": "Works with llama.cpp, Ollama, LM Studio, vLLM, and compatible gateways.",
  ...
  "zh-CN": {
    ...
    "settings.providers.customAdd": "OpenAI 兼容供应商",
    "settings.providers.customAddDesc": "支持 llama.cpp、Ollama、LM Studio、vLLM 和兼容网关。",
  ...
  "zh-TW": {
    ...
    "settings.providers.customAdd": "OpenAI 相容提供者",
    "settings.providers.customAddDesc": "支援 llama.cpp、Ollama、LM Studio、vLLM 和相容閘道。",
  ...
  ja: {
    ...
    "settings.providers.customAdd": "OpenAI 互換プロバイダー",
    "settings.providers.customAddDesc": "llama.cpp、Ollama、LM Studio、vLLM、互換ゲートウェイに対応します。",
