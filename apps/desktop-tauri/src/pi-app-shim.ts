...
export async function installPiApp(): Promise<void> {
  ...
  const piApp = {
    ...
    listCustomModelProviders: call(desktopIpc.listCustomModelProviders),
    probeCustomModelProvider: call(desktopIpc.probeCustomModelProvider),
    saveCustomModelProvider: call(desktopIpc.saveCustomModelProvider),
    removeCustomModelProvider: call(desktopIpc.removeCustomModelProvider),
